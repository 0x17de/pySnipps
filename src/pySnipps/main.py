...
class SnippsGUI:
    ...
    def __init__(self):
        self.g = Gui.init(destroy=self.destroy,
                          catPress=self.catPress,
                          catSelChanged=self.catSelChanged,
                          catNew=self.catNew,
                          catDel=self.catDel,
                          entSelChanged=self.entSelChanged,
                          catToggleAutoexpand=self.catToggleAutoexpand,
                          snippsPress=self.snippsPress,
                          snipNew=self.snipNew,
                          snipCopy=self.snipCopy,
                          snipSave=self.snipSave,
                          snipDel=self.snipDel)
